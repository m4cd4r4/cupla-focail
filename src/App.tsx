...
// Lazy-load the large dictionary dataset
...
export function App() {
  ...
  const results = useMemo(
    () => search(entries, query, { category, limit: 60 }),
    ...
    <div className="min-h-screen bg-dark-900 flex flex-col">
      ...
      <header className="border-b border-white/8 bg-dark-900/80 backdrop-blur-xl sticky top-0 z-20">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/m4cd4r4/irish-dictionary"
              target="_blank"
      ...
      <main className="max-w-3xl mx-auto px-4 pb-16 flex-1 w-full">
        ...
        {!loaded && (
          <div className="flex items-center justify-center py-20">
            <div className="w-8 h-8 border-2 border-shamrock-600 border-t-transparent rounded-full animate-spin" />
          </div>
        )}
